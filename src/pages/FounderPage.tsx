            ...
            <div className="max-w-4xl mx-auto py-12 md:py-20">
                ...
                <div className="grid md:grid-cols-2 gap-8 mb-16">
                    ...
                    >
                        ...
                        <p className="text-muted-foreground leading-relaxed">
                            As a Pune native, Madhur is committed to strengthening the local startup ecosystem. Career OS is optimized to bring the best startup culture directly to Pune's talented student community.
                        </p>
                    </motion.div>
                </div>
                ...
                <section className="mb-16">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        {['Career OS', 'FutoraOne', 'FutoraFlow'].map((item, idx) => (
