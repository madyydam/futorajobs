...
import { Search, Filter, Mail, Award, Activity, Loader2, ArrowRight, BookOpen, Users, Shield, ShieldCheck, User } from "lucide-react";
...
const UserManagement = () => {
    ...
    const handleRoleUpdate = async (userId: string, newRole: string | null) => {
                            ...
                            <tbody className="divide-y divide-border/50">
                                {isLoading ? (
                                    ...
                                    filteredUsers?.map((user) => (
                                        <tr key={user.id} className="group hover:bg-white/[0.01] transition-colors relative">
                                            ...
                                            <td className="px-8 py-6">
                                                <div className="flex flex-col items-center gap-2">
                                                    ...
                                                    <div className="text-[9px] text-neutral-600 font-bold uppercase tracking-widest mt-1">
                                                        {user.availability}
                                                    </div>
                                                </div>
                                            </td>
                                                ...
                                                <div className="flex items-center justify-end gap-4">
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        >
                                                            ...
                                                            <option value="curriculum_admin">Curriculum Admin</option>
                                                            <option value="hiring_admin">Hiring Admin</option>
